...
echo '<div class="w-100 pt-4 pb-4" style="background: #ffffff;">
        <div class="container" id="footer-area">
            <div class="row">
                <div class="col-md-4">
                    <img src="http://localhost/my-projects/other-files/other-clients/b-educated/assets/logo2.webp" height="50px" width="50px">
                    <h5 class="mt-3"><b>BeEducated</b></h5>
                    <p class="text-muted" style="font-size: 14px;">Be educated so that you can<br>change the world.</p>
                </div>
                <div class="col-md-4">
                    <p style="color: #eb554d;"><b>Important Links</b></p>
                    <p>
                        <a href="#">Home</a><br>
                        <a href="#">About</a><br>
                        <a href="#">Contact</a><br>
                ...
                <div class="col-md-4">
                    <p style="color: #eb554d;"><b>Other Links</b></p>
                    <p>
