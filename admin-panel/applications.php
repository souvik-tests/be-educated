                    ...
                    echo '<div class="col-md-3 mb-3">
                        <div class="card app-card" style="position: relative;">
                            ...
                            <div class="w-100 mt-2 mb-2 p-1" style="border: 1px solid #ccc; border-radius: 7px;">
                                <table><tr><td><div class="course_logo" style="background-image: url(../_data/_images/'.$a_row['course_id'].'-thumbnail.webp)"></div></td><td class="ps-1"><span style="font-size: 14px;" class="text-deco-2">'.$a_row['title'].'</span></td></tr></table>
                            </div>
