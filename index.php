  ...
  <body>
    ...
    <div class="container" style="margin-top: 100px;">
        <div class="row" style="align-items: center;">
            <div class="col-md-6" style="padding: 0px 30px;" data-aos="fade-in"><h1><b>Be educated so that <span style="color: #497ccf;">you </span> can <span style="color: #497ccf;">change</span> the world.</b></h1>
            <button class="btn btn-main mt-3"><b><i class="bi bi-rocket-takeoff"></i>&nbsp;&nbsp;Explore Courses</b></button>
            </div>
            <div class="col-md-6" data-aos="fade-in"><div class="w-100" style="display: flex; align-items: center; justify-content: center;"><img src="./assets/g1.webp" width="80%"></div></div>
        </div>
    </div>
      
    <!-- popular courses area -->
    <div class="w-100 mt-5 mb-3 pt-5 pb-5" style="background: #edf7ff;">
        <h3 class="text-center mb-4" style="color: #09548C;"><b>Popular Courses</b></h3>
        <div class="container">
                ...
                while($popular_row = mysqli_fetch_assoc($popular)){
                    ...
                    <div class="card course-card h-100" onclick="location.href=&apos;./course/'.$popular_row['alias'].'&apos;" style="cursor: pointer;">
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="w-100 mt-1" style="font-size: 12px; color: #666;"><i class="bi bi-stopwatch" style="color: #497CCF;"></i>&nbsp;&nbsp;'.$popular_row['time_to_complete'].'</div>
    ...
    <div class="container mt-5 mb-5">
        <div class="row" style="align-items: center;">
            <div class="col-md-6 mb-3" data-aos="fade-in">
    ...
    <!-- category area -->
    <div class="w-100 mt-5 pt-5 pb-5" style="background: #edf7ff;">
    <div class="container">
        <div class="row" style="align-items: center;">  
            <div class="col-md-6 mb-3" data-aos="fade-in">
                <div class="w-100">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    while($ct_lst = mysqli_fetch_assoc($cat_lists)){
                        echo '<div class="col-md-6 mb-3" data-aos="fade-in">
